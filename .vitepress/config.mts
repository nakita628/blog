...
import { postsTransaction } from '../data/transaction/posts-transaction'
import { tagsTransaction } from '../data/transaction/tags-transaction'
import type { Post } from '../types'

// posts
export const posts: Post[] = postsTransaction()
// tags
export const tags: string[] = tagsTransaction()
  ...
  defineConfig({
    ...
    themeConfig: {
      ...
      socialLinks: [
        ...
        { icon: 'bluesky', link: 'https://bsky.app/profile/mini-bg-pro-n.bsky.social' },
      ],
      search: {
        provider: 'local',
      },
